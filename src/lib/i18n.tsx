...
const initialTranslations: Record<Language, Record<string, string>> = {
  ...
  de: {
    ...
    "Precision vision care, renewed every year": "Erstklassige Sehversorgung, erneuert jedes Jahr",
  ...
  fr: {
    ...
    "Precision vision care, renewed every year": "Soins visuels de précision, renouvelés chaque année",
  ...
  es: {
    ...
    "Precision vision care, renewed every year": "Cuidado visual de precisión, renovado cada año",
    "Fresh prescription glasses delivered to your door every year. Break them or need a new prescription? Three free replacements included. No optician visits, no surprise costs.":

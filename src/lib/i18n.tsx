...
const initialTranslations: Record<Language, Record<string, string>> = {
  ...
  it: {
    "LENSLY CARE VISION SUBSCRIPTION AGREEMENT": "CONTRATTO DI ABBONAMENTO DI ASSISTENZA VISIVA LENSLY CARE",
    "contract.title": "CONTRATTO DI ABBONAMENTO DI ASSISTENZA VISIVA LENSLY CARE",
    "contract.ref_prefix": "Riferimento contratto",
    ...
    "contract.subscription.body": "Lensly Care è un servizio di abbonamento per la vista che fornisce ai clienti l'accesso a vantaggi per occhiali da vista personalizzati. L'abbonamento include:",
    "contract.subscription.item1": "Un (1) paio di occhiali da vista personalizzati completi per anno di contratto.",
    "contract.subscription.item2": "Fino a tre (3) servizi di sostituzione approvati per anno di contratto in base alle condizioni di sostituzione descritte nel presente contratto.",
    "3. Impegno di Consegna di Lensly": "3. Impegno di Consegna di Lensly",
    "contract.delivery.title": "3. Impegno di Consegna di Lensly",
    "contract.delivery.body1": "Una volta che il contratto di abbonamento Lensly Care è stato concluso con successo e il Cliente ha fornito tutte le informazioni richieste, inclusi i dettagli di una prescrizione valida, le informazioni di adattamento e l'approvazione della montatura selezionata, Lensly è obbligata a fornire il beneficio degli occhiali da vista personalizzati inclusi secondo i termini del presente contratto.",
    ...
    "6. Processo di Produzione del Primo Occhiale": "6. Processo di Produzione del Primo Occhiale",
    "contract.first_glasses.title": "6. Processo di Produzione del Primo Occhiale",
    "contract.first_glasses.body1": "Dopo l'attivazione, il Cliente deve fornire tutte le informazioni richieste, inclusi i dettagli di una prescrizione valida, le informazioni di adattamento e le informazioni sulla montatura selezionata.",
    ...
    "contract.first_glasses.changes": "Poiché il primo occhiale è realizzato su misura in base alla prescrizione individuale del Cliente, alle misure e alla montatura selezionata, il Cliente può richiedere modifiche prima della conferma finale dell'ordine del primo occhiale.",
    "contract.first_glasses.final": "Una volta che il Cliente ha confermato l'ordine del primo occhiale tramite un canale di comunicazione approvato da Lensly, inclusa l'e-mail o un altro metodo di comunicazione ufficiale, l'ordine di occhiali personalizzati non può essere annullato o modificato a causa della natura personalizzata del prodotto. Lensly procederà ad adempiere al beneficio visivo confermato in base ai dettagli approvati dal Cliente.",
    ...
    "8. Replacement Coverage": "8. Copertura di Sostituzione",
    "contract.replacement.title": "8. Copertura di Sostituzione",
    "contract.replacement.body1": "Lensly fornisce fino a tre (3) servizi di sostituzione approvati per anno di contratto.",
    "contract.replacement.body2": "La copertura di sostituzione si applica solo nelle seguenti situazioni:",
    ...
    "contract.replacement.item3": "Modifiche di prescrizione verificate.",
    "contract.replacement.proof": "Il Cliente deve fornire una prova adeguata per le richieste di sostituzione. La prova può includere fotografie dei danni, documentazione della prescrizione aggiornata o altre informazioni rilevanti richieste da Lensly.",
    "contract.replacement.excl_title": "La copertura di sostituzione non include:",
    ...
    "contract.adjustments.body1": "Se il Cliente fornisce un valido motivo, tra cui: Prescrizione errata rispetto alla prescrizione inviata; Specifiche delle lenti errate; Problemi di montaggio o di produzione confermati relativi alla montatura; Lensly sostituirà le lenti interessate gratuitamente previa verifica.",
    ...
    "11. Laboratory and Supplier Processing": "11. Elaborazione del Laboratorio e dei Fornitori",
    "contract.laboratory.title": "11. Elaborazione del Laboratorio e dei Fornitori",
    "contract.laboratory.body1": "Lensly lavora con fornitori di ottica e laboratori selezionati per la produzione e l'adattamento di occhiali da vista.",
    ...
    "contract.ownership.body1": "Dopo il successo della consegna degli occhiali completati, la proprietà della montura e delle lenti si trasferisce al Cliente.",
    "13. Early Cancellation": "13. Risoluzione Anticipata",
    "contract.early_cancellation.title": "13. Risoluzione Anticipata",
    "contract.early_cancellation.body1": "L'abbonamento Lensly Care ha una durata contrattuale minima di dodici (12) mesi. La risoluzione anticipata durante questo periodo non è generalmente disponibile.",
    ...
    "Customer Acceptance": "Accettazione del Cliente",
    "contract.acceptance.title": "Accettazione del Cliente",

...
const initialTranslations: Record<Language, Record<string, string>> = {
  ...
  de: {
    ...
    "Total realistic cost over 2 years: €696": "Realistische Gesamtkosten über 2 Jahre: 696 €",
  ...
  fr: {
    ...
    "Total realistic cost over 2 years: €696": "Coût réel sur 2 ans : 696 €",
  ...
  es: {
    ...
    "Total realistic cost over 2 years: €696": "Coste real en 2 años: 696 €",
  ...
  it: {
    ...
    "Total realistic cost over 2 years: €696": "Costo reale su 2 anni: 696 €",

...
const initialTranslations: Record<Language, Record<string, string>> = {
  ...
  de: {
    ...
    "Zero hidden fees, 1 pair per year and 3 replacements per year": "Keine versteckten Gebühren, 1 Brille pro Jahr und 3 Ersatzgläser pro Jahr",
    ...
    "Lensly is a small independent team focused on making quality prescription eyewear affordable and accessible across Europe. We work directly with certified optical labs to cut out retail markups.": "Lensly ist ein kleines, unabhängiges Team, das sich darauf konzentriert, hochwertige Korrektionsbrillen in ganz Europa erschwinglich und zugänglich zu machen. Wir arbeiten direkt mit zertifizierten Optiklaboren zusammen, um Händlerspannen zu vermeiden.",
    "Can I see frame options before subscribing?": "Kann ich die Brillengestelle vor dem Abonnement sehen?",
    "Yes. You choose any frame you like, from any brand, online shop, or store. Send us a photo or screenshot and we source it for you. No limitations.": "Ja. Sie können jedes beliebige Gestell wählen – von jeder Marke, aus jedem Online-Shop oder Ladengeschäft. Schicken Sie uns einfach ein Foto oder einen Screenshot und wir besorgen es für Sie. Keine Einschränkungen.",
    "What is the exact process for my first pair?": "Wie läuft der Prozess für meine erste Brille genau ab?",
    "1. Subscribe via Stripe": "1. Über Stripe abonnieren",
    "Select your plan and complete checkout securely.": "Wählen Sie Ihren Plan und schließen Sie den Checkout sicher ab.",
    "2. E-mail contact within 24 hours": "2. Kontakt per E-Mail innerhalb von 24 Stunden",
    "We reach out to gather your custom prescription details.": "Wir melden uns bei Ihnen, um die Details Ihres Brillenglaskonzepts zu erfassen.",
    "3. Send us prescription, pupillary distance & chosen frame": "3. Rezept, Pupillendistanz (PD) & Wunschgestell zusenden",
    "Simply reply with your values and a photo/screenshot of any frame you want.": "Antworten Sie einfach mit Ihren Werten und einem Foto/Screenshot des gewünschten Gestells.",
    "4. Sourcing & production": "4. Beschaffung & Anfertigung",
    "We purchase your frame and craft your custom lenses to specification.": "Wir erwerben Ihr Gestell und fertigen Ihre maßgeschneiderten Gläser nach Ihren Angaben an.",
    "5. Delivered to your door": "5. Lieferung direkt zu Ihnen",
    "Your finished prescription eyewear arrives in approximately 15 days.": "Ihre fertige Korrektionsbrille kommt in ca. 15 Tagen bei Ihnen an.",
    "How do I get my pupillary distance measured?": "Wie messe ich meine Pupillendistanz (PD)?",
    "Visit any local optician or doctor for a quick measurement. It takes 2 minutes and is usually free. Then just include it in your email to us.": "Besuchen Sie einen lokalen Optiker oder Augenarzt für eine schnelle Messung. Es dauert nur 2 Minuten und ist in der Regel kostenlos. Fügen Sie den Wert einfach Ihrer E-Mail an uns bei.",
    "What if my lenses are wrong?": "Was ist, wenn meine Gläser nicht stimmen?",
    "We send a replacement pair free of charge, no questions asked.": "Wir senden Ihnen kostenlos und ohne Rückfragen ein neues Paar zu.",
    "How do returns or refunds work?": "Wie funktionieren Rückgaben oder Rückerstattungen?",
    "If there is a production error on our side we fix it completely free. Custom prescription lenses cannot be refunded once produced, but we will always make it right.": "Bei Produktionsfehlern unsererseits beheben wir diese vollkommen kostenlos. Da es sich um maßgefertigte Korrektionsgläser handelt, ist eine Rückerstattung nach der Produktion ausgeschlossen, aber wir finden immer eine zufriedenstellende Lösung.",
    "Do I buy the frame or do you?": "Kaufe ich das Gestell selbst oder übernehmen Sie das?",
    "We source the frame for you based on your photo or screenshot. It is included in your subscription, nothing extra to pay.": "Wir beschaffen das Gestell basierend auf Ihrem Foto oder Screenshot für Sie. Es ist in Ihrem Abonnement enthalten – Sie müssen nichts extra bezahlen.",
  },
  fr: {
    ...
    "Lensly is a small independent team focused on making quality prescription eyewear affordable and accessible across Europe. We work directly with certified optical labs to cut out retail markups.": "Lensly est une petite équipe indépendante dédiée à rendre les lunettes de vue de qualité abordables et accessibles dans toute l'Europe. Nous travaillons directement avec des laboratoires d'optique certifiés pour éliminer les marges des distributeurs.",
    "Can I see frame options before subscribing?": "Puis-je voir les montures avant de m'abonner ?",
    "Yes. You choose any frame you like, from any brand, online shop, or store. Send us a photo or screenshot and we source it for you. No limitations.": "Oui. Vous choisissez la monture de votre choix, de n'importe quelle marque, boutique en ligne ou magasin. Envoyez-nous une photo ou une capture d'écran et nous la trouverons pour vous. Aucune limite.",
    "What is the exact process for my first pair?": "Quel est le processus exact pour ma première paire ?",
    "1. Subscribe via Stripe": "1. S'abonner via Stripe",
    "Select your plan and complete checkout securely.": "Sélectionnez votre offre et finalisez votre paiement en toute sécurité.",
    "2. E-mail contact within 24 hours": "2. Contact par e-mail sous 24h",
    "We reach out to gather your custom prescription details.": "Nous vous contactons pour recueillir les détails de votre ordonnance.",
    "3. Send us prescription, pupillary distance & chosen frame": "3. Envoi de l'ordonnance, de l'écart pupillaire et de la monture choisie",
    "Simply reply with your values and a photo/screenshot of any frame you want.": "Répondez simplement avec vos informations et une photo/capture d'écran de la monture de votre choix.",
    "4. Sourcing & production": "4. Achat de la monture & fabrication",
    "We purchase your frame and craft your custom lenses to specification.": "Nous achetons la monture et fabriquons vos verres correcteurs sur mesure.",
    "5. Delivered to your door": "5. Livraison chez vous",
    "Your finished prescription eyewear arrives in approximately 15 days.": "Vos lunettes de vue terminées arrivent chez vous sous environ 15 jours.",
    "How do I get my pupillary distance measured?": "Comment faire mesurer mon écart pupillaire ?",
    "Visit any local optician or doctor for a quick measurement. It takes 2 minutes and is usually free. Then just include it in your email to us.": "Rendez-vous chez un opticien ou un médecin local pour une mesure rapide. Cela prend 2 minutes et c'est généralement gratuit. Indiquez-la simplement dans votre e-mail.",
    "What if my lenses are wrong?": "Que faire si mes verres ne conviennent pas ?",
    "We send a replacement pair free of charge, no questions asked.": "Nous vous envoyons une paire de remplacement gratuitement, sans poser de questions.",
    "How do returns or refunds work?": "Comment fonctionnent les retours ou remboursements ?",
    "If there is a production error on our side we fix it completely free. Custom prescription lenses cannot be refunded once produced, but we will always make it right.": "En cas d'erreur de fabrication de notre part, nous la corrigeons gratuitement. Les verres correcteurs personnalisés ne peuvent pas être remboursés une fois produits, mais nous ferons toujours le nécessaire pour vous satisfaire.",
    "Do I buy the frame or do you?": "Est-ce moi qui achète la monture ou vous ?",
    "We source the frame for you based on your photo or screenshot. It is included in your subscription, nothing extra to pay.": "Nous trouvons la monture pour vous à partir de votre photo ou capture d'écran. Elle est incluse dans votre abonnement, aucun frais supplémentaire à prévoir.",
  },
  es: {
    ...
    "Zero hidden fees, 1 pair per year and 3 replacements per year": "Sin cuotas ocultas, 1 par al año y 3 reemplazos al año",
    "€7-20/month": "7-20 €/mes",
    "€29/month": "29 €/mes",
    "Frequently Asked Questions": "Preguntas Frecuentes",
    "Everything you need to know": "Todo lo que necesitas saber",
    "Who is behind Lensly?": "¿Quién está detrás de Lensly?",
    "Lensly is a small independent team focused on making quality prescription eyewear affordable and accessible across Europe. We work directly with certified optical labs to cut out retail markups.": "Lensly es un pequeño equipo independiente enfocado en hacer que las gafas graduadas de calidad sean asequibles y accesibles en toda Europa. Trabajamos directamente con laboratorios ópticos certificados para eliminar los márgenes de los intermediarios.",
    "Can I see frame options before subscribing?": "¿Puedo ver las opciones de monturas antes de suscribirme?",
    "Yes. You choose any frame you like, from any brand, online shop, or store. Send us a photo or screenshot and we source it for you. No limitations.": "Sí. Eliges la monture que quieras: de cualquier marca, tienda online o tienda física. Envíanos una foto o captura de pantalla y nosotros la conseguimos para ti. Sin límites.",
    "What is the exact process for my first pair?": "¿Cuál es el proceso exacto para mi primer par?",
    "1. Subscribe via Stripe": "1. Suscríbete mediante Stripe",
    "Select your plan and complete checkout securely.": "Selecciona tu plan y completa el pago de forma segura.",
    "2. E-mail contact within 24 hours": "2. Contacto por e-mail en 24 horas",
    "We reach out to gather your custom prescription details.": "Nos comunicamos contigo para recopilar los detalles de tu receta.",
    "3. Send us prescription, pupillary distance & chosen frame": "3. Envíanos tu receta, distancia pupilar y montura elegida",
    "Simply reply with your values and a photo/screenshot of any frame you want.": "Simplemente responde con tus datos y una foto/captura de la montura que desees.",
    "4. Sourcing & production": "4. Obtención y fabricación",
    "We purchase your frame and craft your custom lenses to specification.": "Adquirimos tu montura y elaboramos tus lentes personalizadas según tus especificaciones.",
    "5. Delivered to your door": "5. Entrega a domicilio",
    "Your finished prescription eyewear arrives in approximately 15 days.": "Tus gafas graduadas terminadas llegarán a tu puerta en unos 15 días.",
    "How do I get my pupillary distance measured?": "¿Cómo mido mi distancia pupilar?",
    "Visit any local optician or doctor for a quick measurement. It takes 2 minutes and is usually free. Then just include it in your email to us.": "Visita a cualquier óptico o médico local para una medición rápida. Lleva solo 2 minutos y suele ser gratuita. Luego inclúyela en el correo que nos envíes.",
    "What if my lenses are wrong?": "¿Qué pasa si mis lentes están mal?",
    "We send a replacement pair free of charge, no questions asked.": "Te enviamos un par de reemplazo gratis, sin hacer preguntas.",
    "How do returns or refunds work?": "¿Cómo funcionan las devoluciones o reembolsos?",
    "If there is a production error on our side we fix it completely free. Custom prescription lenses cannot be refunded once produced, but we will always make it right.": "Si hay un error de fabricación por nuestra parte, lo solucionamos gratis. Las lentes graduadas personalizadas no se pueden reembolsar una vez fabricadas, pero siempre buscaremos una solución.",
    "Do I buy the frame or do you?": "¿Tengo que comprar la montura yo o la compráis vosotros?",
    "We source the frame for you based on your photo or screenshot. It is included in your subscription, nothing extra to pay.": "Nosotros conseguimos la montura basándonos en tu foto o captura. Está incluida en tu suscripción, no tienes que pagar nada extra.",
  },
  it: {
    ...
    "Zero hidden fees, 1 pair per year and 3 replacements per year": "Nessun costo nascosto, 1 paio all'anno e 3 sostituzioni all'anno",
    ...
    "Lensly is a small independent team focused on making quality prescription eyewear affordable and accessible across Europe. We work directly with certified optical labs to cut out retail markups.": "Lensly è un piccolo team indipendente dedicato a rendere gli occhiali da vista di qualità convenienti e accessibili in tutta Europa. Lavoriamo direttamente con laboratori ottici certificati per eliminare i ricarichi dei rivenditori.",
    "Can I see frame options before subscribing?": "Posso vedere le opzioni di montatura prima di abbonarmi?",
    "Yes. You choose any frame you like, from any brand, online shop, or store. Send us a photo or screenshot and we source it for you. No limitations.": "Sì. Scegli tu la montatura che preferisci da qualsiasi marchio, negozio online o fisico. Inviaci una foto o uno screenshot e noi la reperiremo per te. Senza limiti.",
    "What is the exact process for my first pair?": "Qual è la procedura esatta per il mio primo paio?",
    "1. Subscribe via Stripe": "1. Abbonati con Stripe",
    "Select your plan and complete checkout securely.": "Seleziona il tuo piano e completa il pagamento in sicurezza.",
    "2. E-mail contact within 24 hours": "2. Contatto via e-mail entro 24 ore",
    "We reach out to gather your custom prescription details.": "Ti contatteremo per raccogliere i dati della tua ricetta medica.",
    "3. Send us prescription, pupillary distance & chosen frame": "3. Inviaci ricetta, distanza pupillare e montatura scelta",
    "Simply reply with your values and a photo/screenshot of any frame you want.": "Rispondi all'e-mail con i tuoi parametri e la foto/screenshot della montura desiderata.",
    "4. Sourcing & production": "4. Reperimento e produzione",
    "We purchase your frame and craft your custom lenses to specification.": "Acquistiamo la montatura e realizziamo le lenti su misura secondo le tue specifiche.",
    "5. Delivered to your door": "5. Consegna a domicilio",
    "Your finished prescription eyewear arrives in approximately 15 days.": "I tuoi occhiali da vista pronti arriveranno a destinazione in circa 15 giorni.",
    "How do I get my pupillary distance measured?": "Come faccio a misurare la distanza pupillare?",
    "Visit any local optician or doctor for a quick measurement. It takes 2 minutes and is usually free. Then just include it in your email to us.": "Visita un ottico o un medico locale per una misurazione rapida. Richiede 2 minuti ed è generalmente gratuita. Poi inseriscila nella tua e-mail.",
    "What if my lenses are wrong?": "Cosa succede se le lenti sono errate?",
    "We send a replacement pair free of charge, no questions asked.": "Ti invieremo un paio sostitutivo gratuitamente, senza fare domande.",
    "How do returns or refunds work?": "Come funzionano i resi o i rimborsi?",
    "If there is a production error on our side we fix it completely free. Custom prescription lenses cannot be refunded once produced, but we will always make it right.": "In caso di errore di produzione da parte nostra, lo risolveremo gratuitamente. Le lenti da vista personalizzate non sono rimborsabili una volta prodotte, ma troveremo sempre il modo di soddisfare le tue esigenze.",
    "Do I buy the frame or do you?": "La montura la compro io o voi?",
    "We source the frame for you based on your photo or screenshot. It is included in your subscription, nothing extra to pay.": "Reperiamo noi la montatura per te in base alla tua foto o screenshot. È inclusa nel tuo abbonamento, non devi pagare nulla in più.",
  },
};

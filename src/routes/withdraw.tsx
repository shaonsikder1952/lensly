...
export const Route = createFileRoute("/withdraw")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Statutory online withdrawal page for your Lensly Care subscription.",
      },
    ],
  }),
        ...
        <main className="mx-auto max-w-md px-4 py-16 sm:px-6">
          <div className="bg-card rounded-2xl border border-border shadow-md p-6 sm:p-8 text-center animate-in fade-in duration-200">
            ...
            <p className="mt-3 text-xs sm:text-sm text-muted-foreground leading-relaxed">
              {t("Please send us an email with your contract details to confirm your withdrawal request.")}
            </p>
            ...
            <div className="mt-6 text-[10.5px] text-muted-foreground leading-relaxed border-t border-border/60 pt-4">
              {t("Our support team will process your withdrawal request and send you a confirmation receipt within 24 hours.")}
            </div>
          </div>
        </main>
      </div>
